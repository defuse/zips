...
\introlist
Then to encrypt\footnote{\href{https://github.com/defuse/librustzcash/blob/linkdemo1/zcash_primitives/src/note_encryption.rs\#L302}{DOC:ZP:6rs1uiXvP64s}}:

\begin{algorithm}
\item choose a uniformly random ephemeral private key $\EphemeralPrivate \leftarrowR \KASaplingPrivate \setminus \setof{0}$\footnote{\href{https://github.com/defuse/librustzcash/blob/9d6f63fd9a35564d2964a0fa8d70db646a8aea0a/zcash_primitives/src/note_encryption.rs\#L141}{DOC:ZP:9wbsF-McWWvb}}
...
components of the \noteCiphertext as
follows\footnote{\href{https://github.com/defuse/librustzcash/blob/linkdemo1/zcash_primitives/src/note_encryption.rs\#L397}{DOC:ZP:L-9nrnp8oDEE}}:
...
It is instantiated using the $\BlakeTwobGeneric$ \hashFunction defined in
\crossref{concreteblake2} \footnote{\href{https://github.com/defuse/librustzcash/blob/9d6f63fd9a35564d2964a0fa8d70db646a8aea0a/zcash_primitives/src/note_encryption.rs\#L22}{DOC:ZP:OgWNfu810kUH}}:
...
It is instantiated using the $\BlakeTwosGeneric$ \hashFunction defined in \crossref{concreteblake2}\footnote{DOC:ZP:7Buk5lYNz0Rg: \href{https://github.com/defuse/librustzcash/blob/9d6f63fd9a35564d2964a0fa8d70db646a8aea0a/zcash_primitives/src/note_encryption.rs\#L24}{1}, \href{https://github.com/defuse/librustzcash/blob/linkdemo1/zcash_primitives/src/note_encryption.rs\#L193}{2}}:
...
Define $\KASaplingAgree(\sk, P) := \scalarmult{\ParamJ{h} \mult
\sk}{P}$.\footnote{\href{https://github.com/defuse/librustzcash/blob/9d6f63fd9a35564d2964a0fa8d70db646a8aea0a/zcash_primitives/src/note_encryption.rs\#L157}{DOC:ZP:yPWO7VlEy9dN}}
} %sapling
...
A first network upgrade, called \Overwinter, activated on the production \Zcash network
...
This change does not apply to the production network.
...
\subsubsubsection{Checking that affine-ctEdwards coordinates are on the curve} \label{cctedvalidate}
...
\introsection
\subsubsubsection{ctEdwards [de]compression and validation} \label{ccteddecompressvalidate}
...
\introlist
\subsubsubsection{ctEdwards \lrarrow\ Montgomery conversion} \label{cctconversion}
...
\introlist
\subsubsubsection{Affine-ctEdwards arithmetic} \label{cctedarithmetic}
...
\introsection
\subsubsubsection{Affine-ctEdwards nonsmall-order check} \label{cctednonsmallorder}
...
\introsection
\subsubsubsection{Fixed-base affine-ctEdwards scalar multiplication} \label{cctfixedscalarmult}
...
\introsection
\subsubsubsection{Variable-base affine-ctEdwards scalar multiplication} \label{cctvarscalarmult}
...
%      = \WindowedPedersenCommit{\NoteCommitRand}(\vOldRepr \bconcat \DiversifiedTransmitBaseRepr \bconcat \DiversifiedTransmitPublicRepr)
  ...
  $\nfOld{} = \PRFnfSapling{\AuthProvePublicRepr}(\NoteAddressRandRepr)$
      &
      & 21262 & \shortcrossref{cctblake2s} \\ \hline
  \raggedright pack $\nfOld{\barerange{0}{250}}$ and $\nfOld{\barerange{251}{255}}$ into two $\GF{\ParamS{r}}$ inputs
      & input encoding
